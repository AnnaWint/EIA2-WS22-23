namespace A08_GenerativeArt {
        ...
        function drawObjectRandom(): void {
        ...
        function drawLine(): void {
                ...
                let lineColor: string[] = ["#D49CFA", "#040EDB", "#FA257E"];

                for (let i: number = 0; i < lineColor.length; i++)
        ...
        function drawArc(): void {
                ...
                let arc: CanvasRenderingContext2D = <CanvasRenderingContext2D>canvas.getContext("2d");
                let size: number = randomNumber(1, 150);
                arc.fillStyle = "purple";
                arc.strokeStyle = "purple";
                for (let i: number = 0; i < 10; i++) {

                        let x: number = Math.random() * arc.canvas.width;
                        let y: number = Math.random() * arc.canvas.height;
