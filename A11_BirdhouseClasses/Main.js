...
(function (A11_BirdhouseClasses) {
    ...
    let background;
    let moveable = [];
    A11_BirdhouseClasses.canvas.addEventListener("click", shootBird);
    function handleLoad() {
        // console.log("load");
        A11_BirdhouseClasses.canvas = document.querySelector("canvas");
        A11_BirdhouseClasses.crc2 = A11_BirdhouseClasses.canvas.getContext("2d");
        drawBackground();
    ...
    function createmovableobjects() {
        ...
        for (let i = 0; i < 250; i++) {
            let snowflake = new A11_BirdhouseClasses.Snowflake();
            moveable.push(snowflake);
        }
        for (let iBird = 0; iBird < 15; iBird++) {
            let bird = new A11_BirdhouseClasses.Bird("red");
            moveable.push(bird);
        }
    }
    function update() {
        // console.log("update");
        A11_BirdhouseClasses.crc2.putImageData(background, 0, 0);
    ...
    function drawStanding() {
        ...
        let x = randomNumber(0, A11_BirdhouseClasses.canvas.width);
        let y = randomNumber(600, 800);
        A11_BirdhouseClasses.crc2.save();
        A11_BirdhouseClasses.crc2.translate(x, y);
        A11_BirdhouseClasses.crc2.beginPath();
        A11_BirdhouseClasses.crc2.fillStyle = "red";
        A11_BirdhouseClasses.crc2.arc(0, 0, 10, 0, 2 * Math.PI);
        A11_BirdhouseClasses.crc2.ellipse(-25, 20, 10, 25, 20, 0, 360);
        A11_BirdhouseClasses.crc2.moveTo(-30, 30);
        A11_BirdhouseClasses.crc2.lineTo(-30, 53);
        A11_BirdhouseClasses.crc2.moveTo(-25, 30);
        A11_BirdhouseClasses.crc2.lineTo(-25, 53);
        A11_BirdhouseClasses.crc2.fill();
        A11_BirdhouseClasses.crc2.moveTo(1, -5);
        A11_BirdhouseClasses.crc2.lineTo(20, -5);
        A11_BirdhouseClasses.crc2.lineTo(1, 2);
        A11_BirdhouseClasses.crc2.stroke();
        A11_BirdhouseClasses.crc2.strokeStyle = "red";
    ...
    A11_BirdhouseClasses.randomNumber = randomNumber;
    function drawBackground() {
        let gradient = A11_BirdhouseClasses.crc2.createLinearGradient(0, 0, 0, A11_BirdhouseClasses.crc2.canvas.height);
        gradient.addColorStop(0, "#94CEFF");
        gradient.addColorStop(horizont, "#F3FAF0");
        gradient.addColorStop(1, "#BEE0F5");
        A11_BirdhouseClasses.crc2.fillStyle = gradient;
        A11_BirdhouseClasses.crc2.fillRect(0, 0, A11_BirdhouseClasses.crc2.canvas.width, A11_BirdhouseClasses.crc2.canvas.height);
        let startMountain = A11_BirdhouseClasses.crc2.canvas.height * horizont;
        ...
        drawStanding();
        background = A11_BirdhouseClasses.crc2.getImageData(0, 0, A11_BirdhouseClasses.crc2.canvas.width, A11_BirdhouseClasses.crc2.canvas.height);
    }
    function drawSun(_position) {
        let sunCircle = A11_BirdhouseClasses.canvas.getContext("2d");
        let r1 = 25;
        let r2 = 150;
        let gradient = A11_BirdhouseClasses.crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawCloud(_position, _size) {
        let cloudCircle = A11_BirdhouseClasses.canvas.getContext("2d");
        let nParicles = 20;
        let radiusParticle = 50;
        let particle = new Path2D();
        let gradient = A11_BirdhouseClasses.crc2.createRadialGradient(0, 0, 0, 0, 0, radiusParticle);
    ...
    function drawMountain(_position, _min, _max, _colorLow, _colorHigh) {
        let mountainLine = A11_BirdhouseClasses.canvas.getContext("2d");
        let stepMin = 100;
        let stepMax = 200;
        let x = 0;
        mountainLine.save();
    ...
    function drawTree(_position, _max) {
        let tree = A11_BirdhouseClasses.canvas.getContext("2d");
        tree.save();
    ...
    function drawSnowman(_position) {
        let snowmanCircle = A11_BirdhouseClasses.canvas.getContext("2d");
        let r1 = 60;
        let r2 = 50;
        let r3 = 40;
        snowmanCircle.save();
    ...
    function drawBirdhouse(_position) {
        let house = A11_BirdhouseClasses.canvas.getContext("2d");
        house.save();
